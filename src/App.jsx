...
export default function App() {
  ...
  switch (page) {
      ...
      return (
        <div style={{ fontFamily: "'DM Sans',sans-serif", background: "#050c18", color: "#c8d8e8", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", padding: 40 }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: "#5a7a9a", marginBottom: 32, lineHeight: 1.8 }}>Your subscription is active. Log in with your email to access the dashboard.</p>
    ...
    case "/admin":
      return (
        <AdminGate>
          <AdminPanel onPublish={handlePublish} onNavigate={navigate} allSignals={allSignals} />
        </AdminGate>
      );
    default:
      return <LandingPage onNavigate={navigate} />;
