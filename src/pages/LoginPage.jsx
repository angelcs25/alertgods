...
export default function LoginPage({ onNavigate = () => {}, onLogin }) {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans','Segoe UI',sans-serif", background: "#050c18", color: "#c8d8e8", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <style>{`
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        .li { width:100%; background:#0a1220; border:1px solid #1a2a3a; color:#c8d8e8; font-family:'DM Sans',sans-serif; font-size:15px; padding:14px 16px; border-radius:3px; outline:none; transition:border-color .2s; }
        .li:focus { border-color:#00c97a; }
        .li::placeholder { color:#2a3a4a; }
        .lb { width:100%; background:#00c97a; color:#030f08; border:none; padding:14px; border-radius:3px; font-family:'DM Sans',sans-serif; font-size:15px; font-weight:700; cursor:pointer; transition:background .2s; }
        .lb:hover:not(:disabled) { background:#00e688; }
      ...
      <div style={{ width: 380, padding: "0 20px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <div style={{ fontSize: 13, color: "#2a4060", marginTop: 8 }}>Signal Dashboard</div>
        </div>
        ...
        <div style={{ textAlign: "center", marginTop: 20, display: "flex", justifyContent: "center", gap: 20 }}>
          ...
          <button onClick={() => onNavigate("/signup/pro")} style={{ background: "none", border: "none", color: "#00c97a", fontFamily: "inherit", fontSize: 13, cursor: "pointer" }}>
            Get Pro →
          </button>
        </div>
      </div>
